...
<html>
	...
	<!-- Animate.css -->
	<link rel="stylesheet" href="asset/style2/css/animate.css">
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="asset/style2/css/icomoon.css">
	<!-- Bootstrap  -->
	<link rel="stylesheet" href="asset/style2/css/bootstrap.css">

	<!-- Magnific Popup -->
	<link rel="stylesheet" href="asset/style2/css/magnific-popup.css">

	<!-- Theme style  -->
	<link rel="stylesheet" href="asset/style2/css/style.css">

	<!-- Modernizr JS -->
	<script src="asset/script/modernizr-2.6.2.min.js"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
				...
				<div class="col-md-12 col-md-offset-0 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeInUp">
							<h1 class="mb30">Never Stop Exploring.</h1>
							<p>
								<a href="http://freehtml5.co/" target="_blank" class="btn btn-primary">Download</a> or 
